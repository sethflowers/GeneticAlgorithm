...
namespace GeneticAlgorithm
{
    ...
    public class TournamentSelector<T> : ChromosomeSelector<T>
    {
            ...
            double totalFitness)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("chromosomes", "The number of players in a tournament selection needs to be between 2 and the size of the population.");
            }
